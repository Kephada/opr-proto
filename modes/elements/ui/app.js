...
import { SHOP_REROLL_COST, sizeLabel } from '../engine/config.js';
...
// Namespaced per mode: an ELEMENTS run must never rehydrate the base game.
const SAVE_KEY = 'opr-elements-save-v1';
...
function openReward() {
  setTimeout(() => {
    if (run.phase !== PHASE.REWARD) return;
    const rerollLabel = 'reroll Ã‚Â· 3g';
